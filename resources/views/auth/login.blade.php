...
<body class="h-full bg-gray-100 font-poppins">
    <div class="flex flex-col justify-center min-h-full sm:px-6 lg:px-8">
        <div class="sm:mx-auto sm:w-full sm:max-w-md">
            <div class="flex justify-center mb-2">
                <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" class="w-24 h-24"
                    viewBox="0 0 888 618.10603" xmlns:xlink="http://www.w3.org/1999/xlink">
                    <path
                        ...
                        transform="translate(-156 -140.94698)" fill="#2f2e41" />
                    <path
                        ...
                        transform="translate(-156 -140.94698)" fill="#ffb9b9" />
                    <path
                        ...
                        transform="translate(-156 -140.94698)" fill="#e6e6e6" />
                    <path
                    ...
                    <path
                        ...
                        transform="translate(-156 -140.94698)" fill="#00bfa6" />
                    <path
                    ...
                    <path
                        ...
                        transform="translate(-156 -140.94698)" fill="#3f3d56" />
                    <path
                    ...
                    <path
                        ...
                        transform="translate(-156 -140.94698)" fill="#fff" />
                    <polygon
                        points="737.354 62.46 736.646 61.753 737.646 60.753 743.62 53.781 744.38 54.431 738.38 61.431 737.354 62.46"
                        fill="#fff" />
                    <rect x="830.99973" y="198.1481" width="1.00054" height="7.81025"
                        transform="translate(-12.03491 570.53091) rotate(-50.19443)" fill="#fff" />
                    <rect x="880.4712" y="217.30312" width="19.55761" height="1.0002"
                        transform="matrix(0.537, -0.84358, 0.84358, 0.537, 72.44944, 710.89356)" fill="#fff" />
                    <rect x="834.2499" y="208.02442" width="1.0002" height="19.55761"
                        transform="translate(-142.42964 341.26087) rotate(-32.47119)" fill="#fff" />
                    <path
                    ...
                    <path
                        ...
                        transform="translate(-156 -140.94698)" fill="#9f616a" />
                    <path
                    ...
                    <path
                        ...
                        transform="translate(-156 -140.94698)" fill="#fff" />
                    <rect x="301.94089" y="206.06748" width="1.00054" height="8.33965"
                        transform="translate(-208.68499 167.04408) rotate(-50.19486)" fill="#fff" />
                    <rect x="354.73467" y="226.55581" width="20.88467" height="1.0002"
                        transform="matrix(0.537, -0.84358, 0.84358, 0.537, -178.46379, 272.23589)" fill="#fff" />
                    <rect x="305.41177" y="216.61358" width="1.0002" height="20.88467"
                        transform="matrix(0.84366, -0.53687, 0.53687, 0.84366, -230.07485, 58.78582)" fill="#fff" />
                    <path
                    ...
                    <path
                        ...
                        transform="translate(-156 -140.94698)" fill="#00bfa6" />
                    <polygon points="71.79 172.661 95.866 176.96 150.897 255.207 121.662 248.328 71.79 172.661"
                        fill="#e6e6e6" />
                    <path
                    ...
                    <path
                        ...
                        transform="translate(-156 -140.94698)" opacity="0.2" />
                    <path
            ...
            <x-card>
                <div class="mb-2">
                    <h1 class="text-2xl font-semibold text-gray-600">Sign in to your account</h1>
                </div>
                <x-errors />
                @if (session('status'))
                <div class="mb-4 text-sm font-medium text-green-600">
                ...
                <form class="space-y-6" action="{{ route('login') }}" method="POST">
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <input id="email" name="email" type="email" autocomplete="email" required
                                class="block w-full px-3 py-2 text-gray-700 placeholder-gray-400 border border-gray-300 rounded-md shadow-sm appearance-none placeholder:text-gray-600 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                        </div>
                    </div>
                    <div>
                    ...
                    <div class="flex justify-end w-full pt-3 border-t">
                        <button type="submit"
